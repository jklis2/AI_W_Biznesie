    ...
    <PageHeader backgroundImage="/headerBackgrounds/home.jpg" title="My Account">
      <div className="py-5 px-5 w-full">
        ...
        <form onSubmit={handleUpdate} className="space-y-6">
          ...
          <button
            type="submit"
            className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-black hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 hover:cursor-pointer">
            Update Profile
          </button>
        </form>
      </div>
